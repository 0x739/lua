...
HopFrame.BackgroundTransparency = 0 -- Không trong suốt
...
UIStroke.Color = Color3.fromRGB(255, 255, 255) -- Màu viền trắng
UIStroke.Thickness = 2.5 -- Độ dày viền
...
HopIn.Size = UDim2.new(0, 400, 0, 60)
HopIn.Name = "HopIn"
